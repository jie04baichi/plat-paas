...
public class CipherUtil {
    ...
    public static byte[] generateKey() {
        try {
            ...
            return Ascii2HexUtil.hex2Ascii(secretKey.getEncoded());
        } catch (Exception e) {
    ...
    public static String encrypt(String data) {
        byte[] aa = encrypt(data.getBytes(), Ascii2HexUtil.ascii2Hex(SECURITY_KEY.getBytes()),DES_ECB_ALGORITHM);
        return new String(Ascii2HexUtil.hex2Ascii(aa));
    }
    
    public static String decrypt(String data) {
        byte[] aa = Ascii2HexUtil.ascii2Hex(data.getBytes());
        return new String(decrypt(aa, Ascii2HexUtil.ascii2Hex(SECURITY_KEY.getBytes()),DES_ECB_ALGORITHM));
    }
    
    public static String encrypt(String data, String algorithm) {
        byte[] aa = encrypt(data.getBytes(), Ascii2HexUtil.ascii2Hex(SECURITY_KEY.getBytes()),algorithm);
        return new String(Ascii2HexUtil.hex2Ascii(aa));
    }
    
    public static String decrypt(String data, String algorithm) {
        byte[] aa = Ascii2HexUtil.ascii2Hex(data.getBytes());
        return new String(decrypt(aa, Ascii2HexUtil.ascii2Hex(SECURITY_KEY.getBytes()),algorithm));
    }
